...
def sms():
    ...
    if 'good morning' in incoming_msg:
        ...
        msg.body('suraj singh made me.❤️❤️')

    elif "who are you" in incoming_msg:
        #! Telling who am I
        msg.body('I am called Whatsapp Bot made by Suraj singh.❤️❤️')
        ...
        try:
            try:
                url = f'http://www.omdbapi.com/?s={name}&apikey=88321181'
                r = requests.get(url)
                rj = r.json()
                search = rj['Search']
                for data in search:
            ...
            url2 = f'http://www.omdbapi.com/?i={iD}&apikey=88321181'
        ...
        r = requests.get(f'https://api.openweathermap.org/data/2.5/weather?q={city_name}&appid=19b94252dff72915dfd11d3d18092a1d&units=metric')
        try:
            data = r.json()
            name = data['name']
